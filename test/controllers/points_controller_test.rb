...
class PointsControllerTest < ActionController::TestCase
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post :create, point: { lat: @point.lat, lng: @point.lng, pointid: @point.pointid, routeid: @point.routeid }
    end
  ...
  test "should update point" do
    patch :update, id: @point, point: { lat: @point.lat, lng: @point.lng, pointid: @point.pointid, routeid: @point.routeid }
    assert_redirected_to point_path(assigns(:point))
  end
