...
var FileLoader = L.Class.extend({
    ...
    _loadGeoJSON: function (content) {
        ...
        //var feature = content.features[0];
        //var points3D = feature.geometry.coordinates;
        //var numPts = points3D.length;
        //alert(numPts);
        //var i;
        //
        //var points2D = [];
        ...
        //    var point = [x, y];
        //
        //    //points2D.push( points3D[i].slice(0, 2) );
        //    points2D.push( point );
        //}
        //
        //console.log(points2D);
        //alert("Check console for points2D");
        //var line = L.polyline(points2D).addTo(this._map);
        //line.enableEdit();
